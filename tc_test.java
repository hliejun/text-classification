...
public class tc_test {
    public static void main(String[] args) {
        ...
        if (args.length >= 3) {
            ...
            // CLASSIFY
                // 3. Create weight vector based on features selected from training text
                // 4. Dot product with each perceptron classifier weight vector
                // 5. Label text with the class whose weight vector gives the greatest dot product value
